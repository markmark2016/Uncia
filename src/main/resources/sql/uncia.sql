...
(
  ID BIGINT(20) PRIMARY KEY NOT NULL,
  ACCOUNT_ID BIGINT(20) DEFAULT '1' NOT NULL COMMENT '账户ID',
  ROLE VARCHAR(32) DEFAULT 'USER' NOT NULL COMMENT '用户角色',
  CREATE_TIME DATETIME DEFAULT '1970-00-00 00:00:00' NOT NULL COMMENT '创建时间',
  MOD_TIME TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL
);